...
export default function Home({ navigation }: P) {
  ...
  return (
    <View className="flex-1 bg-white p-6">
      ...
      <TouchableOpacity className="btn bg-purple-500 mt-4" onPress={() => navigation.navigate("NotchedNavExample")}>
        <Text className="text-white font-semibold">View Notched Bottom Nav</Text>
      </TouchableOpacity>
      
      <Pressable onPress={onLogout} className="rounded-full bg-teal-400 px-6 py-3 mt-4">
